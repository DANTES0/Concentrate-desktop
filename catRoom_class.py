...
class Shop_item(QWidget):
    def __init__(self, xcor: int, ycor: int, cat_image_path: str, price: int, cat_name: str, shadow_color: str):
        ...
        self.shadow = QLabel(self)
        self.shadow.setParent(self.based)
        self.shadow.setGeometry(3, 9, 152, 180)
        self.shadow.setStyleSheet(f"background: {shadow_color}; border-radius: 30px")
        self.shop_item_bg = QLabel(self)
        self.shop_item_bg.setParent(self.based)
        self.shop_item_bg.setGeometry(0, 0, 146, 180)
        self.shop_item_bg.setStyleSheet("background: #FFFFFF; border-radius: 30px")
        self.cat_image = QLabel(self)
        self.cat_image.setParent(self.shop_item_bg)
        img = QPixmap(cat_image_path)
        self.cat_image.setPixmap(img)
        self.cat_image.setGeometry(12, 45, 128, 80)
        self.cat_image.setStyleSheet("background: transparent;")
        self.cat_name = QLabel(self)
        self.cat_name.setParent(self.shop_item_bg)
        self.cat_name.setGeometry(0, 0, 140, 40)
        self.cat_name.setText(cat_name)
        self.cat_name.setObjectName("cat_name")
        self.cat_name.setStyleSheet(open('source/CatRoom_sheetstyles.qss').read())
...
class CatRoom(QMainWindow):
    ...
    def load_store(self):
        ...
        self.cat_6 = Shop_item(358, 235, "source/Mr_Chief.png", 2345, "Mr.Chief", "#81455E")
        self.cat_6.setParent(self.mywidget)
        self.cat_6.show()

        self.cat_8 = Shop_item(288, 442, "source/Kirill.png", 5134, "Kirill", "#81455E")
        self.cat_8.setParent(self.mywidget)
        self.cat_8.show()

        self.cat_7 = Shop_item(124, 442, "source/Prince.png", 1000, "Prince", "#81455E")
        self.cat_7.setParent(self.mywidget)
        self.cat_7.show()
